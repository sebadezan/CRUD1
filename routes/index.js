...
var novedadesModel = require('../models/novedadesModel');  // Corrección en la importación

router.get('/', async function (req, res, next) {
  try {
    var novedades = await novedadesModel.getNovedades();  // Corrección del uso de la función
...
router.post('/', async (req, res, next) => {
  try {
    var { nombre, apellido, dni, telefono, email } = req.body;  // Desestructuración para simplificar
